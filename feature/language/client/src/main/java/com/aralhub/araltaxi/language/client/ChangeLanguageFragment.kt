package com.aralhub.araltaxi.language.client
...
import com.aralhub.araltaxi.language.client.databinding.FragmentChangeLanguageBinding
...
class ChangeLanguageFragment : Fragment(R.layout.fragment_change_language) {
    ...
    private fun setupUI() {
        updateLanguageContainerByIndex(clientSharedPreference.languageIndex)
    }
    ...
    private fun setupListeners() {
        binding.apply {
            ...
            qrLanguageContainer.setOnClickListener {
                clientSharedPreference.languageIndex = 0
                updateLanguageContainerByIndex(0)
            }
            ruLanguageContainer.setOnClickListener {
                clientSharedPreference.languageIndex = 1
                updateLanguageContainerByIndex(1)
            }
            btnSave.setOnClickListener {
                Lingver.getInstance().setLocale(
                    requireContext(),
                    if (clientSharedPreference.languageIndex == 0) QR_LANGUAGE_CODE else RU_LANGUAGE_CODE
                )
